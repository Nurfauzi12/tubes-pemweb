    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-white active">Tambah</li>
        </ol>
        <h3 class="font-weight-bolder text-white mb-0">Tambah CPMK</h3>
      </nav>
    </div>
  </nav>
  <!-- End Navbar -->
      ...
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-header pb-0">
            <h5 class="mb-0">Form Tambah CPMK</h5>
            <h6 class="text-sm text-secondary mb-0">
              Lengkapi data Capaian Pembelajaran Mata Kuliah
            </h6>
          ...
          <div class="card-body pt-4">
            <form action="<?= base_url('master/cpmk/new') ?>" method="post" id="formCpmk">
                  ...
                  <div class="form-group mb-4">
                    ...
                    <select name="id_matakuliah"
                      ...
                      <?php foreach ($matakuliah_list ?? [] as $m): ?>
                        <option value="<?= $m['id'] ?>"
                          <?= old('id_matakuliah') == $m['id'] ? 'selected' : '' ?>>
                ...
                <div class="col-12">
                  <div class="form-group mb-4">
                    ...
                    <input type="text"
                           ...
                           value="<?= old('cpmk') ?>"
                           placeholder="Contoh: Mahasiswa mampu menjelaskan konsep..."
                           required>
...
<script>
  document.getElementById('formCpmk').addEventListener('submit', function(e) {
