    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h3 class="font-weight-bolder text-white mb-0">Tambah Rencana Pembelajaran</h3>
        </nav>
      </div>
    </nav>
        ...
        <div class="col-12">
          <div class="card mb-0">
            <div class="card-header pb-0">
                <h5>Form Tambah Rencana Pembelajaran</h5>
                <div class="card-body px-0 pt-0 pb-2">
                    <form action="<?= base_url('table/rencana-pembelajaran/new') ?>" method="post" id="text-editor">
                        <div class="row">
                          <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="minggu_ke" class="form-control" placeholder="Minggu Ke" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="sub_cpmk">Sub CPMK</label>
                            <input type="text" name="sub_cpmk" class="form-control" placeholder="Sub CPMK" required>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="penilaian_indikator">Penilaian Indikator</label>
                                <input type="text" name="penilaian_indikator" class="form-control" placeholder="Penilaian Indikator" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="penilaian_teknik">Penilaian Teknik</label>
                                <input type="text" name="penilaian_teknik" class="form-control" placeholder="Penilaian Teknik" required>
                            </div>
                          </div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="bentuk_pembelajaran">Bentuk Pembelajaran</label>
                            <input type="text" name="bentuk_pembelajaran" class="form-control" placeholder="Bentuk Pembelajaran" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="materi">Materi</label>
                            <textarea name="materi" class="form-control" placeholder="Materi" rows="3" required></textarea>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="bobot_penilaian">Bobot Penilaian</label>
                                <input type="text" name="bobot_penilaian" class="form-control" placeholder="Bobot Penilaian" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group mb-3">
